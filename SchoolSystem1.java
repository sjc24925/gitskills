...
public  class SchoolSystem implements ISignUp,IParams {
	...
	public void shengyu(int n) {
		...
		if(Big>sum1) {
			int a=Big-sum1;
			System.out.println("大班还可入学："+a);
		}	
		else System.out.println("大班还可入学：0");
		if(Medium>sum2) {
			int b=Medium-sum2;
			System.out.println("中班还可入学："+b);
		}	
		else System.out.println("中班还可入学：0");
		if(Small>sum3) {
			int c=Small-sum3;
			System.out.println("小班还可入学："+c);
		}	
		else System.out.println("小班还可入学：0");
